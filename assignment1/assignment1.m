...
originalWeightPounds = originalWeightkg * 2.20462;
originalWeightOunces = originalWeightPounds * 16;
disp ('=== After creating variables ===');
who;
whos;
clear originalWeightPounds;
disp ('=== After clearing originalWeightPounds ===');
who;
whos;
